...
export default async function HabitacionesPage() {
  const sliderImages = await readPhotos("caballos/photos");
    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#134e4a_0%,#0f172a_45%,#020617_100%)] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16 pt-28 md:pt-32">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-3 text-4xl font-semibold md:text-6xl">Slider Caballos</h1>
          <p className="mx-auto mt-4 max-w-2xl text-base text-white/80 md:text-lg">
            Galerie dédiée avec les photos de chevaux, même style que la page Nouvelles.
          </p>
        </div>
